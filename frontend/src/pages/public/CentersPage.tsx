...
import { MapPin, Phone, Clock, Users, ArrowRight, ShieldCheck, Search, Filter } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {filteredCenters.map((center) => {
            ...
            return (
              <div key={center.id} className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 flex items-center gap-1 mb-4">
                    ...
                    <span>{center.location.address}, {center.location.district}</span>
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-3 my-4 bg-slate-50 p-3.5 rounded-2xl border border-slate-100 text-xs">
                    ...
                    <div className="pt-2 border-t border-slate-200/60 col-span-2">
                      <div className="flex justify-between text-[11px] font-medium text-slate-600 mb-1">
                        <span>Intake Capacity: {center.bookedQuantity} / {center.capacityPerDay} Q</span>
